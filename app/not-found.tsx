  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen p-4'>
        <div className='text-center'>
            <h1 className='text-col font-bold text-primary mb-4'>404</h1>
            <h2 className='text-2xl font-semibold mb-8 max-w-md'>Page Not Found</h2>
            <p className='text-muted-foreground mb-8 max-w-md'>
                Don&apos;t worry, enven the best data somethings gets lost in the internet.
            </p>
        ...
        <div className='mt-12 text-center'>
          <footer className='text-sm text-muted-foreground'>
            if you belive this is an error, please contact support
          </footer>
        </div>
    </div>
  )
